...
void HPRN(const pcl::PointCloud<pcl::PointNormal>::ConstPtr& cloud_in, std::vector<float> camera_pos, int param, pcl::PointCloud<pcl::PointNormal>::Ptr& cloud_out) // Hidden Point Removal
{
	int dim = 3;
	int numPts = cloud_in->size();
